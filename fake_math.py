...
def divide(first, second):
    ...
    if second == 0:        # Функция возвращает(return) строку 'Ошибка', когда в second записан 0 - <if second == 0>
        return "Ошибка"
    else:                       # Функция возвращает(return) результат деления(/) first на second
        return first / second
